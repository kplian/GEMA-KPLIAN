...
?>
<script>
Phx.vista.Metodologia=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			...
			type:'TextField',
			filters:{pfiltro:'gemeto.codigo',type:'string'},
			id_grupo:1,
			grid:true,
			form:true
		},
		{
			...
			type:'TextField',
			filters:{pfiltro:'gemeto.nombre',type:'string'},
			id_grupo:1,
			grid:true,
			form:true
		},
		{
			...
			type:'TextField',
			filters:{pfiltro:'gemeto.estado_reg',type:'string'},
			id_grupo:1,
			grid:true,
			form:false
		},
		...
		},
		{
			...
			type:'DateField',
			filters:{pfiltro:'gemeto.fecha_reg',type:'date'},
			id_grupo:1,
			grid:true,
			form:false
		},
		...
		},
		{
			...
			type:'DateField',
			filters:{pfiltro:'gemeto.fecha_mod',type:'date'},
			id_grupo:1,
			grid:true,
			form:false
		}
