...
BEGIN
	...
	***********************************/
	...
	if(p_transaccion='GEM_TEQ_INS')then
        ...
        begin
			...
			v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Definir Tipo de Equipos almacenado(a) con exito (id_tipo_equipo'||v_id_tipo_equipo||')'); 
	...
	***********************************/
		...
		begin
			...
			--Definicion de la respuesta
            v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Definir Tipo de Equipos modificado(a)'); 
	...
	***********************************/
		...
		begin
            ...
            --Definicion de la respuesta
            v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Definir Tipo de Equipos eliminado(a)'); 
            v_resp = pxp.f_agrega_clave(v_resp,'id_tipo_equipo',v_parametros.id_tipo_equipo::varchar);
