CREATE OR REPLACE FUNCTION gem.ft_falla_evento_externo_sel (
...
BEGIN
	...
	v_nombre_funcion = 'gem.ft_falla_evento_externo_sel';
	...
	***********************************/
	...
	if(p_transaccion='GEM_GEFAEVE_SEL')then
	...
	***********************************/
	...
	elsif(p_transaccion='GEM_GEFAEVE_CONT')then
