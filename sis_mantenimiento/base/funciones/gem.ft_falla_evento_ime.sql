CREATE OR REPLACE FUNCTION "gem"."ft_falla_evento_ime" (	
...
BEGIN
    ...
    v_nombre_funcion = 'gem.ft_falla_evento_ime';
	...
	***********************************/
	...
	if(p_transaccion='GEM_GEFAEV_INS')then
	...
	***********************************/
	...
	elsif(p_transaccion='GEM_GEFAEV_MOD')then
	...
	***********************************/
	...
	elsif(p_transaccion='GEM_GEFAEV_ELI')then
...
COST 100;
ALTER FUNCTION "gem"."ft_falla_evento_ime"(integer, integer, character varying, character varying) OWNER TO postgres;
