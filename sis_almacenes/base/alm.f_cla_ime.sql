/**************************************************************************
 SISTEMA:		Almacenes
 FUNCION: 		alm.f_cla_ime
 DESCRIPCION:   Funcion que gestiona las operaciones basicas (inserciones, modificaciones, eliminaciones de la tabla 'alm.ctlasificacion'
...
BEGIN
    ...
    v_nombre_funcion = 'alm.f_cla_ime';
