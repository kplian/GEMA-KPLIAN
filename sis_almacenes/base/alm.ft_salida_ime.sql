CREATE OR REPLACE FUNCTION alm.ft_salida_ime (
...
/**************************************************************************
 SISTEMA:        Almacenes
 FUNCION:        alm.ft_salida_ime
 DESCRIPCION:    Funcion que gestiona las operaciones basicas (inserciones, modificaciones, eliminaciones) de la tabla 'alm.tmovimiento' referido s salidas
...
BEGIN
    ...
    v_nombre_funcion = 'alm.ft_salida_ime';
