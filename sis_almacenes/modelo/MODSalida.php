...
class MODSalida extends MODbase{
	...
	function listarSalida(){
		...
		$this->procedimiento='alm.ft_salida_sel';	//nombre de la funcion
		$this->transaccion='SAL_SAL_SEL';
	...
	function insertarSalida(){
		...
		$this->procedimiento='alm.ft_salida_ime';		//nombre de la funcion
		$this->transaccion='SAL_SAL_INS';
	...
	function modificarSalida(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='alm.ft_salida_ime';
		$this->transaccion='SAL_SAL_MOD';
